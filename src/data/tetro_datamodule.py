...
from src.data.components.tetro import TETRO


class TETRODataModule(LightningDataModule):
    ...
    def __init__(
        ...
        transform_list_base.append(transforms.CenterCrop(template_size))
